                        ...
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                <form role="form text-left" method="POST" action="{{route('register.post')}}">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="text" name="f_name" class="form-control" placeholder="First Name" aria-label="Name" aria-describedby="email-addon">
                                    </div>
                                    @error('f_name')
                                        <span style="color:red;">{{$message}}</span>
                                    @enderror
                                    <div class="mb-3">
                                        <input type="text" name="l_name" class="form-control" placeholder="Last Name" aria-label="Name" aria-describedby="email-addon">
                                    </div>
                                    @error('l_name')
                                    <span style="color:red;">{{$message}}</span>
                                    @enderror
...
{{--                                    </div>--}}
                                    ...
                                    <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{route('login.show')}}" class="text-dark font-weight-bolder">Sign in</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
