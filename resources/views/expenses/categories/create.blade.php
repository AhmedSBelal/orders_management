{{-- resources/views/expenses/categories/create.blade.php --}}
@extends('layout.app-dashboard')

@section('title', 'إضافة تصنيف مصروف جديد')
                        ...
                        <div class="row mt-4">
                            <div class="col-12 d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save ms-1"></i> حفظ التصنيف
                                </button>
                            </div>
                        </div>
                    </form>
