...
@push('css')
    ...
    <style>
        ...
        /* لون خاص للجمله */
        #wholesale_type:checked + .order-type-label {
            background-color: #e8f5e8;
            border-color: #28a745;
        }

        #wholesale_type:checked + .order-type-label i,
        #wholesale_type:checked + .order-type-label span {
            color: #28a745;
        }

        /* لون خاص للقطاعي */
        #retail_type:checked + .order-type-label {
            background-color: #e7f1ff;
            border-color: #0d6efd;
        }

        #retail_type:checked + .order-type-label i,
        #retail_type:checked + .order-type-label span {
            color: #0d6efd;
        }
    </style>
@endpush
                                ...
                                <div class="d-flex gap-3">
                                    <div class="order-type-selector">
                                        <input type="radio" name="is_wholesale" id="retail_type" value="0" 
                                            class="order-type-radio" {{ old('is_wholesale', $order->is_wholesale) == 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="order-type-selector">
                                        <input type="radio" name="is_wholesale" id="wholesale_type" value="1" 
                                            class="order-type-radio" {{ old('is_wholesale', $order->is_wholesale) == 1 ? 'checked' : '' }}>
