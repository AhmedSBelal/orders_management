                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <span
                                    class="badge status-badge bg-gradient-{{ $order->status->name == 'قيد التنفيذ' ? 'warning' : ($order->status->name == 'مكتمل' ? 'success' : 'info') }}">
                                    ...
                                    @foreach($products as $product)
                                        <tr class="product-item">
                                            ...
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ $product['size'] }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                            ...
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ number_format($product['price'], 2) }}
                                                    جنيه</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ number_format($product['subtotal'], 2) }}
                                                    جنيه</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                @if($product['is_done'])
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="text-sm font-weight-bold text-success">{{ number_format($order->deposited, 2) }}
                                جنيه</span>
                        </div>
                        @if($order->total_price_after_discount > 0)
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <span
                                    class="text-sm font-weight-bold">{{ number_format($order->total_price_after_discount, 2) }}
                                    جنيه</span>
                            </div>
                        @endif
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="text-sm font-weight-bold text-danger">
                                {{ number_format(($order->total_price_after_discount > 0 ? $order->total_price_after_discount : $order->total_price) - $order->deposited, 2) }}
                                جنيه
                            </span>
                        </div>
                    </div>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('invoice.print', $order->id) }}" class="btn btn-info w-100 mb-2">
